<template>
    <div class="w-screen h-screen flex">
        ...
        <div class="w-full h-full bg-gray-700">
            <div class="h-[50px] bg-gray-400 flex items-center shadow-sm px-[20px] w-full py-[10px] z-10 border-b ">
                    <!-- Hambuger menu -->
                ...
                <div class="w-[calc(100%-30px)] flex">
                        ...
                        <form class="flex items-center w-[500px]">
                            ...
                            <div class="relative w-full">
                                <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                                    <svg aria-hidden="true" class="w-5 h-auto text-gray-700 dark:text-gray-900" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="w-[200px] ">
                        <div class="flex items-center justify-start space-x-4" @click="toggleDrop">
                            <img class="w-10 h-10 rounded-full border-2 border-gray-400" src="/image/rhl.jpeg" alt="">
                            <div class="font-semibold dark:text-white text-left">
                                <div>Fakhri</div>
                                <div class="text-xs text-gray-900 dark:text-gray-800">Admin</div>
                            </div>
                        </div>
                        <!-- Drop down -->
